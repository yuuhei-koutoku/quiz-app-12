    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                ...
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">問題：問題文です問題文です問題文です</p>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">解説：解説です解説です解説です解説です解説です</p>
            </div>
